...
#AUTHOR : CHIGOZIEWORLDWIDE (SAM)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO SAM
...
header = {"user-agent": '[Mozilla/5.0 (Linux; Android 4.2.2; GT-I9505 Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.59 Mobile Safari/537.36;]',
